        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card card-primary">
                    ...
                    <form id="sumbit_form" action="<?= site_url('average-income/update/'.$result->id) ?>" method="post" autocomplete="off">
                    <?= csrf_field() ?>
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" id="tgl_pembayaran" name="payment_date" value="<?= date('d F Y', strtotime($result->payment_date)) ?>" placeholder="Masukkan Tanggal" required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control rupiah-format" id="pembayaran" name="payment_price" value="<?= number_format($result->payment_price,0,',','.') ?>" placeholder="Dalam Rupiah" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control" id="buruh1_percent" name="buruh1_percent" value="<?= $result->buruh1_percent ?>" placeholder="0 - 100" min="1" max="100" required>
                                            <div class="input-group-append">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control" id="buruh2_percent" name="buruh2_percent" value="<?= $result->buruh2_percent ?>" placeholder="0 - 100" min="1" max="100" required>
                                            <div class="input-group-append">
                                                <span class="input-group-text">%</span>
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control" id="buruh3_percent" name="buruh3_percent" value="<?= $result->buruh3_percent ?>" placeholder="0 - 100" min="1" max="100" required>
                                            <div class="input-group-append">
                                                <span class="input-group-text">%</span>
                                            </div>
                                        </div>
